...
export declare class TextInputLabelComponent implements AfterViewInit {
    ...
    */
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TextInputLabelComponent, "cds-text-label, ibm-text-label", never, { "labelInputID": "labelInputID"; "disabled": "disabled"; "skeleton": "skeleton"; "labelTemplate": "labelTemplate"; "textInputTemplate": "textInputTemplate"; "helperText": "helperText"; "invalidText": "invalidText"; "invalid": "invalid"; "warn": "warn"; "warnText": "warnText"; "ariaLabel": "ariaLabel"; }, {}, never, ["*", "input[type=text],div"], false>;
}
